...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'passkey', component: PasskeyComponent, canActivate: [] },
      { path: 'otp', component: OtpComponent, canActivate: [] },
      { path: 'ask-antispoofing', component: AskAntispoofingComponent, canActivate: [] },
      { path: 'antispoofing', component: AntispoofingComponent, canActivate: [] },
    ],
  },
